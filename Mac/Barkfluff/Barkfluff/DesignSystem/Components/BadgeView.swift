...
/// Псевдоним для бейджа из BFCore (избегаем конфликта с системным типом macOS 26)
...
#Preview {
    VStack(spacing: 20) {
        ...
        BadgesRowView(badges: [
            AppBadge(id: "1", name: "Ранний пользователь", description: ""),
            AppBadge(id: "2", name: "Активный", description: ""),
            AppBadge(id: "3", name: "Разработчик", description: "")
        ], showNames: true)
