...
prefixes='App_|Settings_|Tray_|Welcome_|SelectNode_|ConnectedNode_|Login_|FastAuth_|Registration_|PasswordRecovery_|Messenger_|Nav_|Profile_|Common_|Error_'
