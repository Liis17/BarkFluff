...
{
    /// <summary>
    /// —ервис дл€ создани€ €рлыков в меню "ѕуск"
    /// </summary>
    public class ShortcutService
    {
        ...
        /// <summary>
        /// —оздает €рлык в меню "ѕуск"
        /// “ребует прав администратора
        /// </summary>
        /// <param name="targetPath">ѕуть к исполн€емому файлу BarkFluff</param>
        public void CreateStartMenuShortcut(string targetPath)
        {
            try
            {
                ...
                // ѕолучаем путь к папке Programs в меню ѕуск
        ...
        /// <summary>
        /// —оздает €рлык с указанными параметрами
        /// </summary>
