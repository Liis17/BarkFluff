...
`SettingsPage` — master-detail оболочка с четырнадцатью разделами. Разделы «Безопасность» и «Аккаунт» уже подключены к [[Клиенты/Windows-WebApiCore]]; остальные пока содержат каркас интерфейса и явно помечают недоступные возможности.
