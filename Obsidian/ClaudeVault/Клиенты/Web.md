...
- Клики, клавиши и `contextmenu` делегированы на `#chatList`. `handleOnlineStatus` в `main.js` обновляет только отрисованные `.online-dot`; невидимые строки получат актуальный статус при появлении в окне.
