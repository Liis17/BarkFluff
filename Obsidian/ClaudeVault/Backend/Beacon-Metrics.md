...
| `configuration_fetch_success`          | `Features/GetServerInfo/GetServerInfoCommandHandler.cs`                              | Сколько отдельных запросов в Configuration service завершились успешно (по 7 на каждый `GetServerInfo`).          |
