...
Модалка пользователя на `Pages/v2/users.html` использует компактную ширину 760px, постер профиля с соотношением 3:1 и квадратный аватар. Бейджи находятся рядом с краткой информацией профиля в виде плиток: последняя плитка открывает отдельную форму добавления, а крестик удаления появляется при наведении/фокусе и требует подтверждения. В блоке устройств сначала показываются три сессии с кнопкой разворачивания остальных. Использование хранилища отображается кольцевой диаграммой с сегментами типов файлов, свободным местом лимита и компактной легендой вместо линейного прогрессбара и таблицы.
