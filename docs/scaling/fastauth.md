...
> Статус: план реализован. Смотров историю коммитов `fastauth:` / `configuration:` вокруг
...
5. **Конфиг.** Ключ `Redis` для ServiceId=7 в Configuration (миграция
   `20260814100000_AddRedisConfigurationForFastAuth`), значение подставит
