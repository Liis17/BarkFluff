...
- **Исследование кодовой базы** (поиск файлов, понимание структуры, анализ зависимостей) — используй суб-агент типа `Explore` с параметром `model: "luna" и рассуждением "max"`. Это экономит контекст основной сессии.
