...
- **Settings**: новая миграция `20260721050000_AddFederationChatCreatedQuotaConfiguration` (`Federation:ChatCreatedHourlyLimit` + `Redis` под ServiceId=15) + default `"100"` в каталоге Settings.
