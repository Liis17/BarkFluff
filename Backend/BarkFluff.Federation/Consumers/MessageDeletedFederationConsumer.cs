...
public class MessageDeletedFederationConsumer : IConsumer<MessageDeletedEvent>
{
    ...
    public async Task Consume(ConsumeContext<MessageDeletedEvent> context)
    {
        ...
        evt.MessageDeleted = new MessageDeletedPayload
        {
        ...
        _metrics.Increment("federation_consumer_message_deleted");
    }
