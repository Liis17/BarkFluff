...
namespace BarkFluff.Federation.Features.FederationS2SApi;

public class FederationS2SApiHandler
{
    ...
    private readonly ILogger<FederationS2SApiHandler> _logger;

    public FederationS2SApiHandler(
        ...
        ILogger<FederationS2SApiHandler> logger)
    {
    ...
    public Task<PingResponse> Ping(PingRequest request, ServerCallContext context)
    {
    ...
    public async Task<DeliverTypingResponse> DeliverTyping(
    ...
    public async Task<GetServerKeysResponse> GetServerKeys(GetServerKeysRequest request, ServerCallContext context)
    {
    ...
    public async Task<DeliverEventsResponse> DeliverEvents(DeliverEventsRequest request, ServerCallContext context)
    {
        var origin = context.UserState.TryGetValue("xfed-origin", out var originObj) ? originObj as string : null;
        if (string.IsNullOrEmpty(origin))
        {
