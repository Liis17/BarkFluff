...
namespace BarkFluff.Federation.Features.FederationInternalApi;

public class FederationInternalApiHandler
{
    ...
    public Task<SetPresenceInterestResponse> SetPresenceInterest(
    ...
    public async Task FetchRemoteFile(
        ...
        ServerCallContext context)
    {
        ...
        try
        {
            ...
            var client = new BarkFluff.Proto.Federation.FederationS2SApi.FederationS2SApiClient(invoker);
    ...
    public async Task<DeliverTypingOutboundResponse> DeliverTypingOutbound(
    ...
    public async Task<RotateSigningKeyResponse> RotateSigningKey(RotateSigningKeyRequest request, ServerCallContext context)
    {
    ...
    public async Task<GetKnownServersResponse> GetKnownServers(GetKnownServersRequest request, ServerCallContext context)
    {
    ...
    public async Task<UpsertManualPeerResponse> UpsertManualPeer(UpsertManualPeerRequest request, ServerCallContext context)
    {
    ...
    public async Task<SetServerBlockedResponse> SetServerBlocked(SetServerBlockedRequest request, ServerCallContext context)
    {
        if (!ServernameValidator.TryNormalizeSyntax(request.ServerName, out var normalized))
            throw new InvalidServernameException();
    ...
    public async Task<GetFederationStatusResponse> GetFederationStatus(GetFederationStatusRequest request, ServerCallContext context)
    {
    ...
    public async Task<ResolveRemoteUserResponse> ResolveRemoteUser(ResolveRemoteUserRequest request, ServerCallContext context)
    {
        ...
        try
        {
            ...
            var s2sClient = new BarkFluff.Proto.Federation.FederationS2SApi.FederationS2SApiClient(invoker);
    ...
    public async Task<EnqueueOutboundResponse> EnqueueOutbound(EnqueueOutboundRequest request, ServerCallContext context)
    {
