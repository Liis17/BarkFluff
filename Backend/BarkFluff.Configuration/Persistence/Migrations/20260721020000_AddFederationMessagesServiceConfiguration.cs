...
{
    /// <summary>
    /// Inter-service ключ MessagesService для Federation (ServiceId = 6).
    ...
    public partial class AddFederationMessagesServiceConfiguration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ...
                SELECT v.""Section"", v.""Key"", '', NOW(), 'system', 'migration', 6
                FROM (VALUES
                ...
                WHERE NOT EXISTS (
                    ...
                    WHERE c.""ServiceId"" = 6 AND c.""Section"" = v.""Section"" AND c.""Key"" = v.""Key""
                );
            ");
        }
