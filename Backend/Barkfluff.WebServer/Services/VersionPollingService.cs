...
public class VersionPollingService : BackgroundService
{
    ...
    [
        ...
        ("https://storage.barkfluff.com/get/barkfluffkotlin/dev/version",
            (s, v) => s.SetAndroidDev(v)),
        ("https://storage.barkfluff.com/get/barkfluffkotlin/nightly/version",
            (s, v) => s.SetAndroidNightly(v)),
        ("https://storage.barkfluff.com/get/barkfluffwinui/release/version",
            (s, v) => s.SetWindowsRelease(v)),
        ("https://storage.barkfluff.com/get/barkfluffwinui/beta/version",
            (s, v) => s.SetWindowsBeta(v)),
        ("https://storage.barkfluff.com/get/barkfluffwinui/dev/version",
            (s, v) => s.SetWindowsDev(v)),
        ("https://storage.barkfluff.com/get/barkfluffwinui/nightly/version",
            (s, v) => s.SetWindowsNightly(v)),
        ...
        ("https://storage.barkfluff.com/get/barkfluffmacos/dev/version",
            (s, v) => s.SetMacosDev(v)),
        ("https://storage.barkfluff.com/get/barkfluffmacos/nightly/version",
            (s, v) => s.SetMacosNightly(v)),
    ];
